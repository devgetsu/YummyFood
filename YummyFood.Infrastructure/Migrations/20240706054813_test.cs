        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Persentage = table.Column<int>(type: "integer", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expired = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviewPhoto = table.Column<string>(type: "text", nullable: false),
                    TimeTableWeekday = table.Column<string>(type: "text", nullable: false),
                    TimeTableWeekend = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Products = table.Column<List<long>>(type: "bigint[]", nullable: false),
                    QuantityPrice = table.Column<decimal>(type: "numeric", nullable: false),
                    ShippingFree = table.Column<decimal>(type: "numeric", nullable: false),
